# 🎮 单词闯关游戏 v2.1.0-realtime

一个支持真实跨设备对战的在线单词学习游戏，专为中小学生设计。采用纯双人对战模式，提供更具竞争性和互动性的学习体验。
...
### 🎯 游戏模式
- **双人对战**: 真实跨设备匹配对战，专注多人竞技体验
- **智能匹配**: 按年级自动匹配同水平玩家
- **AI对手**: 无法匹配时提供AI助手，确保随时可玩
- **三关对战**: 警察抓小偷、登天梯、拔河竞赛
